...
describe('BillingComponent', () => {
  ...
  let fixture: any;
  let billingService: {
    checkExistingInvoice: ReturnType<typeof vi.fn>;
    generateBatchBilling: ReturnType<typeof vi.fn>;
    triggerAllAccountsBilling: ReturnType<typeof vi.fn>;
    triggerAccountBilling: ReturnType<typeof vi.fn>;
    refreshMonthlyBilling: ReturnType<typeof vi.fn>;
    downloadPdfReport: ReturnType<typeof vi.fn>;
    updatePaymentStatus: ReturnType<typeof vi.fn>;
    getAllInvoicesByAccount: ReturnType<typeof vi.fn>
  };
  let analyticsService: {
    getBillingAnalytics: ReturnType<typeof vi.fn>;
    getRevenueHistory: ReturnType<typeof vi.fn>;
    getRevenueForecast: ReturnType<typeof vi.fn>
  };
  ...
  it('should loadForecast with history data', () => {
    analyticsService.getRevenueHistory.mockReturnValue(of({
      data: [{
        billing_period: '2024-01',
        total: 100
      }, {billing_period: '2024-02', total: 200}]
    }));
