...
export class BoitierService {
  ...
  deleteRaws(numBoitier: number, idTrams: number[]): Observable<void> {
    return this.http.delete<void>(`${environment.apiBaseUrl}boities/${numBoitier}/Raw`, {body: idTrams});
  }

  deleteRawsAndArchives(numBoitier: number, idTrams: number[]): Observable<void> {
    return this.http.delete<void>(`${environment.apiBaseUrl}boities/${numBoitier}/RawAndArchives`, {body: idTrams});
  }
